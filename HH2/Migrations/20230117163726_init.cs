        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Users_OfferentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Users_OfferentId",
                        column: x => x.OfferentId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceOffer = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Offerent", "jdsks@com", "Jan Kowalski", "#1234#", "123456", 2 },
                    { 2, "Offerent", "agak@wp.pl", "Aga Kruk", "#$%%^^&&", "444555333", 3 }
                });
