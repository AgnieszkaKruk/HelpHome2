...
namespace HH2
{
    public class HHDbContext : DbContext
    {
       ...
       .HasForeignKey(o => o.UserId);
            ...
            {
                eb.HasKey(u => u.Id);
                eb.Property(u => u.Id).ValueGeneratedOnAdd().HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity<Offer>(eb =>
            {
                eb.HasKey(u => u.Id);
                eb.Property(u => u.Id).ValueGeneratedOnAdd().HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                eb.Property(u => u.CreatedDate).HasDefaultValueSql("getutcdate()").HasPrecision(5);
                eb.Property(u => u.UpdateDate).ValueGeneratedOnUpdate().HasPrecision(5);
                
            });

            modelBuilder.Entity<Event>(eb =>
            {
                eb.Property(u => u.Start).HasPrecision(5);
                eb.Property(u => u.End).HasPrecision(5);
