...

    {
        ...
        public async Task<IActionResult> Login(LoginDto dto)
        {
                ...
                var claimsOfferent = new List<Claim>
            {
                ...
                await HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, principalOfferent,
                    new AuthenticationProperties { IsPersistent = dto.RememberLogin });
